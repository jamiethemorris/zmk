...
#define DT_DRV_COMPAT zmk_behavior_mod_morph_overrides
...
static int on_mod_morph_binding_pressed(struct zmk_behavior_binding *binding,
    ...
    const struct behavior_mod_morph_overrides_config *cfg = dev->config;
    struct behavior_mod_morph_overrides_data *data = dev->data;
    ...
    // Check for override mods first.
    if (current_mods & cfg->override_mods) {
        data->pressed_binding = (struct zmk_behavior_binding *)&cfg->normal_binding;
    } else if (current_mods & cfg->mods) {
...
static const struct behavior_driver_api behavior_mod_morph_overrides_driver_api = {
    .binding_pressed = on_mod_morph_binding_pressed,
    .binding_released = on_mod_morph_binding_released,
};

static int behavior_mod_morph_overrides_init(const struct device *dev) { return 0; }
...
#define KP_INST(n)                                                                                 \
    static struct behavior_mod_morph_overrides_config behavior_mod_morph_overrides_config_##n = {  \
        ...
        .override_mods = COND_CODE_0(DT_INST_NODE_HAS_PROP(n, override_mods), (0),                 \
                                     (DT_INST_PROP(n, override_mods))),                            \
    };                                                                                             \
    static struct behavior_mod_morph_overrides_data behavior_mod_morph_overrides_data_##n = {};    \
    DEVICE_DT_INST_DEFINE(                                                                         \
        n, behavior_mod_morph_overrides_init, NULL, &behavior_mod_morph_overrides_data_##n,        \
        &behavior_mod_morph_overrides_config_##n, APPLICATION,                                     \
        CONFIG_KERNEL_INIT_PRIORITY_DEFAULT, &behavior_mod_morph_overrides_driver_api);
